        ...
        {{session('status')}}
         @include('flash::message')
            ...
            <div class="headbox" style="">
                ...
                <form id="form_index" method="POST" action="{{url('/login')}}">
                    <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"> 
                        ...
                        <div class="row" id="contenedor_input_index" >  
                            ...
                            <input class="inputLogin input_rut vaciar" id="rut" oninvalid="setCustomValidity('Para ingresar debes completar todos lo campos')" oninput="setCustomValidity('')"  name="rut" type="text" maxlength="8" value="{{ old('rut') }}" style="" required >  <!--required autofocus-->
                            ...
                            <input type="password"  class="inputLogin input_password ver_rut vaciar" name="password" id="password" oninvalid="setCustomValidity('Para ingresar debes completar todos lo campos')" oninput="setCustomValidity('')" required> 
                                 @if ($errors->has('rut'))
                                    <span class="help-block">
                                        <div id="rut_invalido" class="alert alert-danger" style="background: white; color:black; border-color:white; font-size: 12px">{{ $errors->first('rut') }}</div>
                                    </span>
                                @endif
                ...
                <div class="col-xs-12 col-md-12" >
                            <div class="col-xs-12 col-md-12"><a class="col-xs-12 col-md-12" href="{{url('password')}}" id="lbl_recuperar_contrasenia">Recuperar Clave</a></div>
                        </div>
            </div>
