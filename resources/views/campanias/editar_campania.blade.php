...
<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
 ...
 <form method="post" id="universo_manual" action="{{ action('CampaniaController@editar',$campania->id) }}" accept-charset="UTF-8" enctype="multipart/form-data">
	...
	<div class="row">
		...
		<div class="col-md-4" style="padding:0px 4px 0px 0px;">
      		...
      		<div class="caja_altura">
                ...
                <div class="col-md-12">
                  <input type="text" class="input_box_text input_border color_letra" name="asunto" value="{{$campania->asunto}}" disabled style="width:100%">               
                </div>

                 
      				   <label class="col-md-12 title_label_panel_doble">Mensaje</label>
                <div class="col-md-12">
                  <textarea name="comentario" rows="10" cols="40" disabled style="resize:none; width:100%; height:130px;">{{$campania->mensaje}}</textarea>
                </div>
       

                <div class="col-md-4" style="padding-right: 2px">
                  <label class="title_label_nueva_campania">Tipo</label><br>
                  <input id="input_tipo" type="text" value="{{$campania->tipo_campania}}" class="input_box_text input_border color_letra" disabled name="hola" style="width:100%"> 
                  
                </div>
                <div class="col-md-4" style="padding-left: 1px; padding-right: 1px">
                  <label class="title_label_nueva_campania">Proceso</label><br>
                  <input type="text" class="input_box_text input_border color_letra" value="{{$campania->proceso}}" disabled style="width:100%"> 
                </div>
                <div class="col-md-4" style="padding-left: 2px" id="univer">
                  <label class="title_label_nueva_campania">Universo</label><br>
        @if($campania->tipo_campania=='automatica')
...
<!--+++++++++++++++++++++++++++++++inicio tipo automatica++++++++++++++++++++++++++++++++++++++++++-->                  
                  <input id="input_automatica" name="universo" type="text" class="input_box_text input_border ocultar_por_tipo_automatica color_letra" value="{{$campania->nombre_universo}}" disabled name="" style="width:100%"> 
...
<!--+++++++++++++++++++++++++++++++inicio tipo manual++++++++++++++++++++++++++++++++++++++++++-->
                  ...
                  <input id="input_automatica" name="universo" type="text" class=" input_border ocultar_por_tipo_automatica color_letra col-md-9" value="{{$campania->nombre_universo}}" disabled name="" style="padding:0px 5px 0px 5px"> 

                  <div class="input-group">
                  <input type="" name="universo_id" value="{{$campania->universos_id}}" style="display:none">
                  <img id="elimina_manual" src="{{url('img/BOTE-BASURA.png')}}" style="background-color: #FC4902; height:25px; width:25px; padding:0px; border:0px" class="input-group-addon" >
                  </div>
...
<!--+++++++++++++++++++++++++++++++fin tipo manual++++++++++++++++++++++++++++++++++++++++++-->                  
                ...
                <label class="title_label_nueva_campania" style="margin-bottom: 10px">Descripción del universo</label><br>
                  <p style="font-size: 9px; font-weight: bold">{{$campania->descripcion}}
                    </p>
                </div>
...
<!-- ++++++++++++++++++++++++++++++inicio por dia ++++++++++++++++++++++++++++++++++++++++++-->         
            <div id="por_dia_div" class="ocultar">
              ...
              <div class="col-md-12">
                  ...
                  <input class="input_box_text_panel col-md-12 input_numeros ciclo_dias" maxlength="4" value="{{$campania->ciclo_dias_0}}" style="width:15%" type="text" oninvalid="setCustomValidity('Completar este campo es obligatorio')" oninput="setCustomValidity('')"  id="">
...
<!-- ++++++++++++++++++++++++++++++inicio por semana ++++++++++++++++++++++++++++++++++++++++++-->      
            <div id="por_semana_div" class="ocultar">
              <label class="col-md-12 title_label">Repetir cada</label><br>
              <div class="col-md-12">
                <input class="input_box_text_panel input_numeros ciclo_semanas input_semanas" value="{{$campania->ciclo_semanas_1}}" maxlength="4" style="width:15%" type="text" name="" oninvalid="setCustomValidity('Completar este campo es obligatorio')" oninput="setCustomValidity('')"  id="">
              ...
              <div id="dia_del_mes_div" class="ocultar_mensual" >
                ...
                <div class="col-md-12">
                  <select class="select_box_body_universo mes_borrar_0 ciclo_meses" style="width:20%" >
                    ...
                    <option  value="{{$campania->repetir_dia_0}}" selected>{{$campania->repetir_dia_0}}</option>
                    @endif
                  <?php for($i=1;$i<31;$i++){?>
                ...
                <div class="col-md-12">
                  <input class="input_box_text_panel col-md-12 input_numeros mes_borrar_0 ciclo_meses" value="{{$campania->por_meses_0}}"  maxlength="4" style="width:15%" type="text"  oninvalid="setCustomValidity('Completar este campo es obligatorio')" oninput="setCustomValidity('')" id="">
              ...
              <div id="dia_semana_mes_div" class="ocultar_mensual" >
                ...
                <div class="col-md-12">
                  <select class="select_box_body_universo mes_borrar_1 ciclo_meses"  style="width:20%" >
                    @if($campania->repetir_el_1=='primer')
                    ...
                    @elseif($campania->repetir_el_1=='segundo')
                      <option value="primer" >Primer</option>
                      <option value="segundo" selected>Segundo</option>              
                      <option value="tercer">Tercer</option>
                      <option value="cuarto">Cuarto</option>
                      <option value="ultimo">Ultimo</option>
                    @elseif($campania->repetir_el_1=='tercer')
                      <option value="primer" >Primer</option>
                      <option value="segundo" >Segundo</option>              
                      <option value="tercer" selected>Tercer</option>
                      <option value="cuarto">Cuarto</option>
                      <option value="ultimo">Ultimo</option>
                    @elseif($campania->repetir_el_1=='cuarto')
                      <option value="primer" >Primer</option>
                      <option value="segundo" >Segundo</option>              
                      <option value="tercer" >Tercer</option>
                      <option value="cuarto" selected>Cuarto</option>
                      <option value="ultimo">Ultimo</option>
                     @elseif($campania->repetir_el_1=='ultimo')
                      <option value="primer" >Primer</option>
                      <option value="segundo" >Segundo</option>              
                      <option value="tercer" >Tercer</option>
                      <option value="cuarto">Cuarto</option>
                ...
                <div class="col-md-12">
                  <select class="select_box_body_universo mes_borrar_1 ciclo_meses"  style="width:30%" >
                    ...
                    @elseif($campania->dia_1=='martes')
                      ...
                      <option value="sabado">Sábado</option>
                      <option value="domingo">Domingo</option> 
                    @elseif($campania->dia_1=='miercoles')
                      <option value="lunes">Lunes</option>
                      <option value="martes">Martes</option>              
                ...
                <label class="col-md-12 title_label">Cada</label><br>
                <div class="col-md-12">
                  <input class="input_box_text_panel col-md-12 input_numeros mes_borrar_1 ciclo_meses" value="{{$campania->por_1}}" maxlength="4" style="width:15%" type="text"  oninvalid="setCustomValidity('Completar este campo es obligatorio')" oninput="setCustomValidity('')" id="">
                  <label class="title_label espacio">Meses</label>
                </div>
              </div>
...
<!-- ++++++++++++++++++++++++++++++inicio por anio ++++++++++++++++++++++++++++++++++++++++++-->
            ...
            <div id="por_anio_div" class="ocultar">
              <label class="col-md-12 title_label">Repetir cada</label><br>
              <div class="col-md-12">
                <input class="input_box_text_panel col-md-12 input_numeros ciclo_anios" value="{{$campania->ciclos_anios}}" maxlength="4" style="width:15%" type="text"  oninvalid="setCustomValidity('Completar este campo es obligatorio')" oninput="setCustomValidity('')" id="">
              ...
              <div class="col-md-12">
                  ...
                  <option value="">Seleccionar...</option>  
                   @if($campania->tipo_ciclo_anio==0)
                    ...
                    @elseif($campania->tipo_ciclo_anio==1)
              ...
              <div id="por_anio_dia_mes_div" class="ocultar_anual">
                ...
                <div class="col-md-12">
                  <select class="select_box_body_universo anio_borrar_0 ciclo_anios"  id="dia_mes_mes" style="width:20%" >
                    ...
                    <option  value="{{$campania->repetir_el_0}}"  selected>{{$campania->repetir_el_0}}</option>
                    @endif
                  <?php for($i=1;$i<31;$i++){?>
                    <option value="<?= $i?>"><?= $i ?></option>
                  <?php }?>
                ...
                <div class="col-md-12">
                  <select class="select_box_body_universo anio_borrar_0 ciclo_anios"  id="select_meses"  style="width:30%" >
                    ...
                    @elseif($campania->del_mes_0=='febrero')
                      ...
                      <option value="noviembre">Noviembre</option>            
                      <option value="diciembre">Diciembre</option>
                    @elseif($campania->del_mes_0=='marzo')
                      <option value="enero">Enero</option>
                      <option value="febrero">Febrero</option>              
                      ...
                      <option value="noviembre">Noviembre</option>            
                      <option value="diciembre">Diciembre</option>
                    @elseif($campania->del_mes_0=='abril')
                      <option value="enero" >Enero</option>
                      <option value="febrero">Febrero</option>              
                      <option value="marzo">Marzo</option>
                      ...
                      <option value="noviembre">Noviembre</option>            
                      <option value="diciembre">Diciembre</option>
                    @elseif($campania->del_mes_0=='mayo')
                      <option value="enero" >Enero</option>
                      <option value="febrero" >Febrero</option>              
                      <option value="marzo">Marzo</option>
                      <option value="abril">Abril</option>
                      ...
                      <option value="noviembre">Noviembre</option>            
                      <option value="diciembre">Diciembre</option>
                    @elseif($campania->del_mes_0=='junio')
                      <option value="enero">Enero</option>
                      <option value="febrero">Febrero</option>              
                      <option value="marzo" >Marzo</option>
                      <option value="abril">Abril</option>
                      ...
                      <option value="noviembre">Noviembre</option>            
                      <option value="diciembre">Diciembre</option>
                    @elseif($campania->del_mes_0=='julio')
                      <option value="enero" >Enero</option>
                      <option value="febrero" >Febrero</option>              
                      <option value="marzo">Marzo</option>
                      <option value="abril">Abril</option>
                      ...
                      <option value="noviembre">Noviembre</option>            
                      <option value="diciembre">Diciembre</option>
                    @elseif($campania->del_mes_0=='agosto')
                      <option value="enero">Enero</option>
                      <option value="febrero">Febrero</option>              
                      <option value="marzo" >Marzo</option>
                      <option value="abril">Abril</option>
                      ...
                      <option value="noviembre">Noviembre</option>            
                      <option value="diciembre">Diciembre</option>
                    @elseif($campania->del_mes_0=='septiembre')
                      <option value="enero" >Enero</option>
                      <option value="febrero">Febrero</option>              
                      <option value="marzo">Marzo</option>
                      <option value="abril" >Abril</option>
                      ...
                      <option value="noviembre">Noviembre</option>            
                      <option value="diciembre">Diciembre</option>
                    @elseif($campania->del_mes_0=='octubre')
                      <option value="enero" >Enero</option>
                      <option value="febrero" >Febrero</option>              
                      <option value="marzo">Marzo</option>
                      <option value="abril">Abril</option>
                      ...
                      <option value="noviembre">Noviembre</option>            
                      <option value="diciembre">Diciembre</option>
                    @elseif($campania->del_mes_0=='noviembre')
                      <option value="enero">Enero</option>
                      <option value="febrero">Febrero</option>              
                      <option value="marzo" >Marzo</option>
                      <option value="abril">Abril</option>
                      ...
                      <option value="diciembre">Diciembre</option>
                    @elseif($campania->del_mes_0=='diciembre')
                      <option value="enero">Enero</option>
                      <option value="febrero">Febrero</option>              
                      <option value="marzo" >Marzo</option>
                      <option value="abril">Abril</option>
                ...
                <div class="col-md-12">
                  <select class="select_box_body_universo anio_borrar_1 ciclo_anios"  style="width:30%" >
                    ...
                    @elseif($campania->mes_1=='agosto')
                      ...
                      <option value="noviembre">Noviembre</option>            
                      <option value="diciembre">Diciembre</option>
                    @elseif($campania->mes_1=='septiembre')
                      <option value="enero" >Enero</option>
                      <option value="febrero">Febrero</option>              
                      <option value="marzo">Marzo</option>
                      <option value="abril" >Abril</option>
                    ...
                    @elseif($campania->mes_1=='octubre')
                      ...
                      <option value="noviembre">Noviembre</option>            
                      <option value="diciembre">Diciembre</option>
                    @elseif($campania->mes_1=='noviembre')
                      <option value="enero">Enero</option>
                      <option value="febrero">Febrero</option>              
                      <option value="marzo" >Marzo</option>
                      <option value="abril">Abril</option>
                      ...
                      <option value="noviembre" selected>Noviembre</option>            
                      <option value="diciembre">Diciembre</option>
                    @elseif($campania->mes_1=='diciembre')
                      <option value="enero">Enero</option>
                      <option value="febrero">Febrero</option>              
                      <option value="marzo" >Marzo</option>
                      <option value="abril">Abril</option>
    ...
    /* border-radius: 25px; */
      ...
      <div class="col-md-4" style="padding:0px 0px 0px 4px">
        <div class="cajas_altura_paneles">
          ...
          <div class="col-md-12">
            <input class="input_box_text_panel col-md-12 datepicker" value="{{$campania->fecha_inicio}}" name="fecha_inicio" type="text" required id="selector">
          </div>
          ...
          <div class="col-md-12">
            ...
            @elseif($campania->tipo_intervalo==1)
              ...
              <option value="finaliza_el">Finaliza el</option>
            @elseif($campania->tipo_intervalo==2)
              <option value="sin_fecha" >Sin fecha de finalización</option>
              <option value="finaliza_despues_de" >Finaliza después de</option>
...
<!-- +++++++++++++++++++++++inicio intervalo finaliza despues de++++++++++++++++++++++++++++++++++++++-->     
            <div id="finaliza_despues_de_div" class="ocultar_intervalo ">
              <div class="col-md-12">      
                ...
                <input class="input_box_text_panel col-md-12 input_numeros intervalo_borrar_0" value="{{$campania->repeticiones}}" maxlength="4" style="width:15%" type="text" id="">
...
<!-- ++++++++++++++++++++++++++++++inicio intervalo finaliza el++++++++++++++++++++++++++++++++++++++-->                  
            <div id="finaliza_el_div" class="ocultar_intervalo">
              <div class="col-md-12">
                <input class="input_box_text_panel col-md-12 datepicker intervalo_borrar_1" value="{{$campania->fecha_fin}}" type="text" id="fecha_fin"   >
              </div>
            </div>
<!-- ++++++++++++++++++++++++++++++fin intervalo finaliza el+++++++++++++++++++++++++++++++++++++++++-->  
      ...
      <!--a id="probar" href="{{url('/probar')}}"><input  style="" class="btn btn-danger btn-sm btn_footer input_btn_buscar_admin_user" type="" value="probar"></a-->							
...
<div style="display:none" id="universo_id">{{$campania->universos_id}}</div>
...
<div id="estado_campania" style="display:none">{{$campania->estado}}</div>
 ...
 <script type="text/javascript"  src="{{url('js/jquery-3.1.1.min.js')}}"></script>
  ...
  <script src="{{url('js/formato_fechas.js')}}"></script> 
    <script src="{{url('js/elimina_universo_manual.js')}}"></script>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('.activa_desactiva').click(function(){
      ...
      $("#guardo_url").text("{{url('estado')}}");
      $('#Modal1').modal('show');
      
    });

    $('#eliminar').click(function(){
      $("#guardo_url").text("{{url('eliminar')}}");
      $("#close-modal").removeClass("play");
      $("#close-modal").addClass("detener");
    ...
    $('#activar').click(function(){
            ...
            $.ajax({
                ...
                success: function(estado){
                  ...
                  if(estado=="eliminado")
                  {
                    window.location.href = "{{url('/listado_campanas')}}";
                  }
