...
<!--+++++++++++++++++++++++++++++++fin tipo manual++++++++++++++++++++++++++++++++++++++++++-->                  
  ...
  <div class="col-md-4" style="padding:0px 2px 0px 2px;">
    ...
    <div class="cajas_cuerpo">
      ...
      <div class="col-md-2">
        <input type="text" class="input_box_text input_border color_letra" value="{{$campania->ciclo_dias_0}}" maxlength="2" disabled name="" style="width:100%">               
      </div>
      ...
      <label class="col-md-12 title_label_panel_doble">Repetir cada</label>
      <div class="col-md-2">
        <input type="text" class="input_box_text input_border color_letra" value="{{$campania->ciclo_semanas_1}}" maxlength="2" disabled name="" style="width:100%">               
      </div>
      <label class="col-md-4 title_label_panel_doble " style="padding:0px;" >Semanas</label>
      @foreach ($dias_1 as $dias)
      <label class="col-md-12 title_label_panel_doble"  >{{$dias}}</label>
      @endforeach
      ...
      <div class="col-md-2">
        <input type="text" class="input_box_text input_border color_letra" value="{{$ciclo->repetir_dia_0}}"  disabled name="" style="width:100%">               
      </div>
      <label class="col-md-12 title_label_panel_doble">Cada</label>
      <div class="col-md-2">
        <input type="text" class="input_box_text input_border color_letra" value="{{$ciclo->por_meses_0}}" disabled name="" style="width:100%">               
      </div>
      <label class="col-md-4 title_label_panel_doble " style="padding:0px;" >Meses</label>
      @elseif ($ciclo->tipo_ciclo_mes==1)
      <label class="col-md-12 title_label_panel_doble">Ciclo</label>
      <div class="col-md-12">
      ...
      <div class="col-md-4">
        <input type="text" class="input_box_text input_border color_letra" value="{{$ciclo->repetir_el_1}}"  disabled name="" style="width:100%">               
      </div>
      <label class="col-md-12 title_label_panel_doble">Día</label>
      <div class="col-md-4">
        <input type="text" class="input_box_text input_border color_letra" value="{{$ciclo->dia_1}}"  disabled name="" style="width:100%">               
      </div>
      <label class="col-md-12 title_label_panel_doble">Cada</label>
      <div class="col-md-2">
        <input type="text" class="input_box_text input_border color_letra" value="{{$ciclo->por_1}}" disabled name="" style="width:100%">               
      </div>
      <label class="col-md-4 title_label_panel_doble " style="padding:0px;" >Meses</label>
      @endif  
      ...
      @if ($ciclo->tipo_ciclo_anio==0)

      <label class="col-md-12 title_label">Repetir cada</label><br>
      <div class="col-md-12">
        <input class="input_box_text_panel col-md-12 input_numeros" disabled value="{{$ciclo->ciclos_anios}}" maxlength="4" style="width:15%" type="text" id="">
      ...
      <div class="col-md-2">
        <input type="text" class="input_box_text input_border color_letra" value="{{$ciclo->repetir_el_0}}"  disabled name="" style="width:100%">               
      </div>
      <label class="col-md-12 title_label_panel_doble">Del mes de</label>
      <div class="col-md-6">
        <input type="text" class="input_box_text input_border color_letra" value="{{$ciclo->del_mes_0}}" disabled name="" style="width:100%">               
      </div>



      @elseif ($ciclo->tipo_ciclo_anio==1)
       <label class="col-md-12 title_label">Repetir cada</label><br>
      <div class="col-md-12">
        <input class="input_box_text_panel col-md-12 input_numeros" disabled value="{{$ciclo->ciclos_anios}}" maxlength="4" style="width:15%" type="text" id="">
        <label class="title_label">años</label>
      ...
      <label class="col-md-12 title_label_panel_doble">El</label>
      <div class="col-md-12">
        <input type="text" class="input_box_text input_border color_letra" value="{{$ciclo->repetir_el_1}}"  disabled name="" style="width:30%">               
      </div>
      <div class="col-md-12">
        <input type="text" class="input_box_text input_border color_letra" value="{{$ciclo->dia_1}}"  disabled name="" style="width:30%;margin-top: 10px">               
      </div>
      <label class="col-md-12 title_label_panel_doble">De</label>
      <div class="col-md-3">
        <input type="text" class="input_box_text input_border color_letra" value="{{$ciclo->mes_1}}" disabled name="" style="width:100%">               
      </div>
...
<div class="col-md-4" style="padding:0px 0px 0px 4px;">
  <div class="caja_altura" >
    ...
    <div class="cajas_cuerpo">
      ...
      <div class="col-md-12">
        <input type="text" class="input_box_text input_border color_letra" value="{{$campania->fecha_inicio}}" disabled name="" style="width:50%">               
      </div>
      ...
      <div class="col-md-3">
        <input type="text" class="input_box_text input_border color_letra" value="{{$campania->repeticiones}}" disabled name="" style="width:100%">               
      </div>
      ...
      <div class="col-md-12">
        <input type="text" class="input_box_text input_border color_letra" value="{{$campania->fecha_fin}}" disabled name="" style="width:100%">               
      </div>
