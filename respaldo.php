...
class NotificacionesController extends Controller
{
            ...
            if($campania->tipo_frecuencia==0){
                ...
                if($campania->tipo_frecuencia==1){
                    ...
                    if($campania->tipo_intervalo==2){
                        ...
                        $repeticiones=$fecha_envio->diffInWeeks($fecha_fin)/$campania->ciclo_semanas_1+1;
    ...
    function arreglo($fecha,$tipo_intervalo){
                        ...
                        if($fecha==Carbon::TUESDAY){                        
                            ...
                            return array('lunes' => 6,'martes' => 0, 'miercoles' => 1, 'jueves' => 2, 'viernes' => 3, 'sabado' => 4, 'domingo' => 5);
                            }
                        ...
                        if($fecha==Carbon::WEDNESDAY){
                          ...
                          if($tipo_intervalo==2){
                            ...
                            return array('lunes' => 5,'martes' => 6, 'miercoles' => 0, 'jueves' => 1, 'viernes' => 2, 'sabado' => 3, 'domingo' => 4);
                            }
                        ...
                        if($fecha==Carbon::THURSDAY){
                           ...
                           if($tipo_intervalo==2){
                            ...
                            return array('lunes' => 4,'martes' => 5, 'miercoles' => 6, 'jueves' => 0, 'viernes' => 1, 'sabado' => 2, 'domingo' => 3);
                            }
