...
<div class="container" id="contenedor_index">
        ...
        <div id="contenedor_caja_index">
            ...
            <div class="headbox" style="">
                ...
                <?php echo Form::open(['url'=>'/password/reset', 'id' => 'form_cambio_clave']); ?>
                        ...
                        <div class="row" id="contenedor_input_index" >   
                            ...
                            <br>                  
                                ...
                                <?php echo Form::password('password',['class' => 'inputLogin input_password confirma', 'id' => 'nueva_clave','oninvalid' => "setCustomValidity('Para recuperar tu clave debes completar todos los campos')",'oninput'=> "setCustomValidity('')",'required'=> 'required']); ?>

                                <!--input type="password" class="inputLogin input_password" id="" required--> 
                                </div>
                                <div class="col-md-12">
                                <label class="lbl_rut_dv" >CONFIRMA NUEVA CLAVE:</label>
                                <?php echo Form::password('password_confirmation',['class' => 'inputLogin input_password confirma','id' => 'confirma_clave','oninvalid' => "setCustomValidity('Para recuperar tu clave debes completar todos los campos')",'oninput'=> "setCustomValidity('')", 'required' => 'required']); ?> 
