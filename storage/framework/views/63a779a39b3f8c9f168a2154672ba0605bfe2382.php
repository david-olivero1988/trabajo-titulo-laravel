...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="cajas_cuerpo">
      ...
      <div class="col-md-12">
            <input type="text" class="input_box_text ancho input_border color_letra" name="asunto" value="<?php echo e($campania->asunto); ?>" disabled style="">
                           
      </div>
      <label class="col-md-12 title_label_panel_doble">Mensaje</label>
      <div class="col-md-12">
            
            <textarea name="comentario" rows="10" cols="40" class="ancho" disabled style="resize:none; height:130px;"><?php echo e($campania->mensaje); ?></textarea>
      </div>


      <div class="col-md-8" style="">
            <label class="title_label_nueva_campania">Universo</label><br>
            <input type="text" class="input_box_text ancho input_border" value="<?php echo e($campania->nombre_universo); ?>" disabled name="" style=""> 
      ...
      <div class="col-md-6" style="padding:0px; margin:0px;">
            <div class="col-md-6 ajustarright" style="">
                  ...
                  <input id="frecuencia" type="text" class="ancho input_box_text input_border" value="<?php echo e($frecuencia); ?>" disabled style="">
...
<!--+++++++++++++++++++++++++++++++++++inicio por dia++++++++++++++++++++++++++++++++++++++++++--> 
            <div id="por_dia" class="ocultar">
                   <div class="col-md-6 ajustar" style="">
                        ...
                        <input id="tipo_ciclo" type="text" class="input_box_text ancho input_border" disabled value="<?php echo e($campania->ciclo_dias_0); ?>" style=""><label class="title_label_nueva_campania" style="margin-top: 0px">Días</label>
...
<!--+++++++++++++++++++++++++++++++++++inicio por semana++++++++++++++++++++++++++++++++++++++++++--> 
      <div id="por_semana" class="ocultar">
             <div class="col-md-6 ajustar" style="">
                  <label class="title_label_nueva_campania">Repetir cada</label><br>
                  <input id="tipo_ciclo" type="text" class="input_box_text ancho input_border" disabled value="<?php echo e($campania->ciclo_semanas_1); ?>" style=""><label class="title_label_nueva_campania" style="margin-top: 0px">Vez, por semana el</label>
                  
            </div>
            <div class="col-md-12 ajustarright" style="">
                  <label class="title_label_nueva_campania">Días</label>
                  <label class="title_label_nueva_campania ancho" style=""><?php echo e($campania->dias_1); ?></label>
...
<!--+++++++++++++++++++++++++++++++++++inicio por mes++++++++++++++++++++++++++++++++++++++++++--> 
      <div id="por_mes" class="ocultar">
                  <input type="text" id="tipo_mes" value="<?php echo e($campania->tipo_ciclo_mes); ?>" style="display:none">
...
<!--+++++++++++++++++++++++++++++++++++inicio dia del mes++++++++++++++++++++++++++++++++++++++++++--> 
            <div id="mensual_dia_mes_div" class="ocultar">
                  <div class="col-md-6 ajustarright" style="">
                        ...
                        <input type="text" class="input_box_text ancho input_border" disabled name="" value="<?php echo e($campania->repetir_dia_0); ?>" style=""> 
                  </div>
                  
                  <div class="col-md-6 ajustar" style="">
                        <label class="title_label_nueva_campania">Cada</label><br>
                        <input type="text" class="input_box_text ancho input_border" disabled name="" value="<?php echo e($campania->por_meses_0); ?>" style=""><label class="title_label_nueva_campania" style="margin-top: 0px">Meses</label>
                  </div>
            </div>      
<!--+++++++++++++++++++++++++++++++++++fin dia del mes++++++++++++++++++++++++++++++++++++++++++--> 
...
<!--+++++++++++++++++++++++++++inicio dia de la semana del mes+++++++++++++++++++++++++++++++++--> 
            ...
            <div id="mensual_dia_semana_mes_div" class="ocultar">
                  <div class="col-md-6 ajustarright" style="">
                        ...
                        <input type="text" class="input_box_text ancho input_border" disabled name="" value="<?php echo e($campania->repetir_el_1); ?>" style=""> 
                  </div>
                  <div class="col-md-6 ajustar" style="">
                        <label class="title_label_nueva_campania">Día</label><br>
                        <input type="text" class="input_box_text ancho input_border" disabled name="" value="<?php echo e($campania->dia_1); ?>" style=""> 
                  </div>
                  
                  <div class="col-md-6 ajustarright" style="">
                        <label class="title_label_nueva_campania">Cada</label><br>
                        <input type="text" class="input_box_text ancho input_border" disabled name="" value="<?php echo e($campania->por_1); ?>" style=""><label class="title_label_nueva_campania" style="margin-top: 0px">Meses</label>
                  </div>
...
<div id="por_anio" class="ocultar">   
            ...
            <div class="col-md-6 ajustar" style="">
                  ...
                  <input type="text" class="input_box_text ancho input_border" value="<?php echo e($campania->ciclos_anios); ?>" disabled name="" style=""> 
            </div>

            <div class="col-md-8 ajustarright" style="">
                  <input type="text" id="tipo_anio" value="<?php echo e($campania->tipo_ciclo_anio); ?>" style="display:none">
...
<!--+++++++++++++++++++++++++++++++++++inicio dia de la semana del mes+++++++++++++++++++++++++++++++++++++++-->
            <div id="anual_dia_mes_div" class="ocultar">
                  ...
                  <div class="col-md-6 ajustar" style="">
                        ...
                        <input type="text" class="input_box_text ancho input_border" disabled name="" value="<?php echo e($campania->mes_1); ?>" style=""> 
                  </div>
            </div>
<!--+++++++++++++++++++++++++++++++++++fin dia de la semana del mes++++++++++++++++++++++++++++++++++++++++++-->
...
<!--+++++++++++++++++++++++++++++++++++inicio dia del mes++++++++++++++++++++++++++++++++++++++++++-->
            <div id="anual_dia_semana_mes_div" class="ocultar">
                  <div class="col-md-4 ajustar" style="">
                        <label class="title_label_nueva_campania">El</label><br>
                        <input type="text" class="input_box_text input_border ancho" disabled name="" value="<?php echo e($campania->repetir_el_0); ?>" style=""> 
                  </div>
                  
                  <div class="col-md-6 ajustarright" style="">
                        <label class="title_label_nueva_campania">Del mes de</label><br>
                        <input type="text" class="input_box_text ancho input_border" disabled name="" value="<?php echo e($campania->del_mes_0); ?>" style=""> 
                  </div>
            </div>
<!--+++++++++++++++++++++++++++++++++++fin dia del mes++++++++++++++++++++++++++++++++++++++++++-->
</div>
<!--+++++++++++++++++++++++++++++++++++fin por anio++++++++++++++++++++++++++++++++++++++++++-->            
      ...
      <div class="col-md-6" style="padding:0px; margin:0px;">
            <div class="col-md-12 ajustarleft" style="">
                  ...
                  <input type="text" class="input_box_text input_border ancho" value="<?php echo e($campania->fecha_inicio); ?>" disabled name="" style=""> 
                  <input id="tipo_intervalo" type="text" class="input_box_text input_border" disabled value="<?php echo e($campania->tipo_intervalo); ?>" name="" style="display:none"> 
            </div>
            ...
            <div id="intervalo_repeticiones" class="col-md-12 ocultar ajustarleft" style="">
                  ...
                  <input  type="text" class="input_box_text ancho input_border" value="<?php echo e($campania->repeticiones); ?>" disabled name="" style=""> 
            ...
            <div id="intervalo_fecha_fin" class="col-md-12 ocultar ajustarleft" style="">
                  ...
                  <input  type="text" class="input_box_text input_border ancho" value="<?php echo e($campania->fecha_fin); ?>" disabled name="" style=""> 
...
<div class="cajas_cuerpo">
    <label class="col-md-12 title_label_panel_doble">Reporte</label>
      <div class="col-md-12">
            <a href="<?php echo e(url('exportar_notificaciones?check_notificaciones_id[]='.$fecha->notificacion_id.'&detalle=detalle')); ?>"><input style="" class="btn btn-danger btn-sm btn_genera_reporte input_btn_buscar_admin_user" type="submit" value="Descargar Reporte de la Notificación"></a>                
      </div>
      <div class="col-md-12">
      ...
      <div class="col-md-12">
            <input type="text" class="input_box_text input_border" disabled="" value="<?php echo e($fecha->fecha_hora_envio); ?>" name="" style="width:40%">               
      </div>
