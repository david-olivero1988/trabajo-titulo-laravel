  ...
  <div class="row">
    ...
    <div class="cajas_cuerpo">
      ...
      <div class="col-md-8" style="">
            ...
            <input type="text" class="input_box_text input_border" value="<?php echo e($campania->nombre_universo); ?>" disabled name="" style="width:100%"> 
      ...
      <div class="col-md-6" style="padding:0px; margin:0px;">
            <div class="col-md-6" style="padding-right: 2px">
                  ...
                  <input id="frecuencia" type="text" class="input_box_text input_border" value="<?php echo e($frecuencia); ?>" disabled style="width:100%">
...
<!--+++++++++++++++++++++++++++++++++++inicio por dia++++++++++++++++++++++++++++++++++++++++++--> 
            <div id="por_dia" class="ocultar">
                   <div class="col-md-6" style="padding-left: 2px; padding-right: 2px">
                        ...
                        <input id="tipo_ciclo" type="text" class="input_box_text input_border" disabled value="<?php echo e($campania->ciclo_dias_0); ?>" style="width:100%"><label class="title_label_nueva_campania" style="margin-top: 0px">Días</label>
...
<!--+++++++++++++++++++++++++++++++++++inicio por semana++++++++++++++++++++++++++++++++++++++++++--> 
      <div id="por_semana" class="ocultar">
             <div class="col-md-6" style="padding-left: 2px; padding-right: 2px">
                  <label class="title_label_nueva_campania">Repetir cada</label><br>
                  <input id="tipo_ciclo" type="text" class="input_box_text input_border" disabled value="<?php echo e($campania->ciclo_semanas_1); ?>" style="width:100%"><label class="title_label_nueva_campania" style="margin-top: 0px">Vez, por semana el</label>
                  
            </div>
            <div class="col-md-12" style=" padding-right: 2px">
                  <label class="title_label_nueva_campania">Días</label>
                  <label class="title_label_nueva_campania" style="width:100%"><?php echo e($campania->dias_1); ?></label>
...
<!--+++++++++++++++++++++++++++++++++++fin por anio++++++++++++++++++++++++++++++++++++++++++-->            
      ...
      <div class="col-md-6" style="padding:0px; margin:0px;">
            <div class="col-md-12" style=" padding-left: 2px;">
                  ...
                  <input type="text" class="input_box_text input_border" value="<?php echo e($campania->fecha_inicio); ?>" disabled name="" style="width:100%"> 
            ...
            <div class="col-md-12 ocultar" style="padding-left: 2px;">
                  <label class="title_label_nueva_campania">Finaliza</label><br>
                  <input id="sin_finalizacion" type="text" class="input_box_text input_border" disabled value="Sin fecha de finalización" name="" style="width:100%"> 
            </div>
            ...
            <div id="intervalo_repeticiones" class="col-md-12 ocultar" style=" padding-left: 2px;">
                  ...
                  <input  type="text" class="input_box_text input_border" value="<?php echo e($campania->repeticiones); ?>" disabled name="" style="width:100%"> 

            </div>

            <div id="intervalo_fecha_fin" class="col-md-12 ocultar" style=" padding-left: 2px;">
                  <label class="title_label_nueva_campania">Fecha</label><br>
                  <input  type="text" class="input_box_text input_border" value="<?php echo e($campania->fecha_fin); ?>" disabled name="" style="width:100%"> 
